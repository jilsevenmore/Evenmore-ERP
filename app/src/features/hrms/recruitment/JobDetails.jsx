...
export default function JobDetails() {
  ...
  if (!job) return <div className="py-10 text-center">Job not found <Button variant="secondary" onClick={() => navigate("/recruitment/jobs")}>Back</Button></div>;
  ...
  return <div className="flex flex-col gap-6">
      <div className="flex flex-wrap justify-between gap-3">
        ...
        <Button onClick={() => navigate("/recruitment/applications")}>View Applicants</Button>
      </div>
